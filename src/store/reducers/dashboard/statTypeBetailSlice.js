...
export const getStatGeneral = createAsyncThunk(
...
const statTypeBetailSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            .addCase(getStatGeneral.pending, (state) => {
                state.status = REQUEST_STATUS.loading
                state.result = []
                state.error = ''
            })
            .addCase(getStatGeneral.fulfilled, (state, action) => {
            ...
            .addCase(getStatGeneral.rejected, (state) => {
